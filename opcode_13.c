...
/**
 * rotl -this is the funct that  rotates the stack to the top
...
/**
 * rotrop - this funct rotates stack to right
 * @stack: pointer that points to the head node pointer of stack
 * @nline: the line number
 * Return: Nothing.
 */
...
/**
 * qpush - this is funct that pushes for queue instead of stack.,
 * @stack: pointer to the head node pointer of stack
 * @nline: the line number
 * Return: Nothing.
 */
